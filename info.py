...
URL = "https://bilorani.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://bilorani.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://bilorani.onrender.com/".format(FQDN)
else:
    URL = "https://bilorani.onrender.com/".format(FQDN)
