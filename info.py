...
URL = "https://video009.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://video009.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://video009.onrender.com/".format(FQDN)
else:
    URL = "https://video009.onrender.com/".format(FQDN)
