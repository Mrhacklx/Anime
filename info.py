...
URL = "https://692e7d18.filebot0.pages.dev".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://692e7d18.filebot0.pages.dev/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://692e7d18.filebot0.pages.dev/".format(FQDN)
else:
    URL = "https://692e7d18.filebot0.pages.dev/".format(FQDN)
