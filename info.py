...
URL = "https://filebot0.pages.dev".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filebot0.pages.dev/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filebot0.pages.dev/".format(FQDN)
else:
    URL = "https://filebot0.pages.dev/".format(FQDN)
