...
URL = "https://xyrx0.leyote6468.workers.dev".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://xyrx0.leyote6468.workers.dev/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://xyrx0.leyote6468.workers.dev/".format(FQDN)
else:
    URL = "https://xyrx0.leyote6468.workers.dev/".format(FQDN)
