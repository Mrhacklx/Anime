...
URL = "https://anime0.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://anime0.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://anime0.onrender.com/".format(FQDN)
else:
    URL = "https://anime0.onrender.com/".format(FQDN)
