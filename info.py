...
URL = "https://ziyamovie9.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://ziyamovie9.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://ziyamovie9.onrender.com/".format(FQDN)
else:
    URL = "https://ziyamovie9.onrender.com/".format(FQDN)
