...
URL = "https://5eeba552.filebot0.pages.dev".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://5eeba552.filebot0.pages.dev/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://5eeba552.filebot0.pages.dev/".format(FQDN)
else:
    URL = "https://5eeba552.filebot0.pages.dev/".format(FQDN)
