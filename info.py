...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002020843727').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/anime_hot_videos1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/anime_hot_videos1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/how_to_open0')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001909719739'))
...
URL = "https://findmovie5.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://findmovie5.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://findmovie5.onrender.com/".format(FQDN)
else:
    URL = "https://findmovie5.onrender.com/".format(FQDN)
